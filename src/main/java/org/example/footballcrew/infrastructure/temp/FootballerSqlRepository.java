...
//
//  @Override
//  public Footballer findFootballerById(UUID id) {
...
//
//  @Override
//  public List<LeagueFootballer> findFootballers() {
//    Map<UUID, List<Exclusion>> exclusionsByFootballerId = new HashMap<>();
//    List<Footballer> footballers = new ArrayList<>();
//    jdbcTemplate.query(
//            "SELECT f.*, e.* FROM footballers as f LEFT JOIN exclusions as e ON f.id = e.footballer_id",
//            rs -> {
//              do {
...
////                ));
//                footballers.add(new LeagueFootballer(
//
//                        UUID.fromString(rs.getString("id")),
